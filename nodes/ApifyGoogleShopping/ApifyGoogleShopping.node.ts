...
import { properties } from './ApifyGoogleShopping.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'U02ytMsu6ynITFJHX' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-shopping-api' as string;
export const CLASS_NAME = 'ApifyGoogleShopping' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-shopping-app' as string;

export const DISPLAY_NAME = 'Google Shopping' as string;
export const DESCRIPTION =
	'Search Google Shopping and return products with prices, sellers, ratings, and links' as string;

export class ApifyGoogleShopping implements INodeType {
